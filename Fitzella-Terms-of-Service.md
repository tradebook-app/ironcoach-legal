...
Fitzella is a fitness tracking and AI-coached training application, offered in three tiers:
- **Manual** (free) — build and log your own routines, sets, and weights, with no AI suggestions
- **AI Suggests** ($6.99/month) — AI-driven training program suggestions and progression, which you review and approve before each session
- **AI Coach** ($9.99/month or $59.99/year) — AI Coach automatically builds and adjusts your program each session, and includes unlimited access to the "Ask Coach" conversational chat feature

## 3. Subscriptions and Payment

- Fitzella offers two optional paid subscription tiers: **AI Suggests** at **$6.99/month**, and **AI Coach** at **$9.99/month** or **$59.99/year**
- The "Ask Coach" conversational chat feature is available only on the AI Coach tier; it is not included with AI Suggests
- New subscribers to a paid tier receive a **7-day free trial**
...
- Cancellations must be made through your Apple ID or Google Play account settings; we do not process cancellations directly
...
The App's AI features (progression suggestions and Ask Coach chat) generate recommendations based on the data you provide. These recommendations are automated and may not always be accurate or appropriate for your specific circumstances. They do not replace professional coaching or medical advice.

## 6. Acceptable Use

You agree not to:
- Use the App for any unlawful purpose
- Attempt to reverse-engineer, hack, or disrupt the App's systems
- Misuse the Ask Coach feature to generate harmful, abusive, or illegal content
